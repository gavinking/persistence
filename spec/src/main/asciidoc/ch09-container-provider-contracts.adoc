...
The `PersistenceProvider` interface may be found in <<_persistenceprovider_>>.
This interface must be implemented by the persistence provider.
...
The `ProviderUtil` interface may be found in <<_providerutil_>>.
...
The `ClassTransformer` interface may be found in <<_classtransformer_>>.
...
The `PersistenceUtil` interface may be found in <<_persistenceutil_>>.
